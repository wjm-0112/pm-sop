...
function MarketResearchDetailPage() {
    ...
    <div className="mx-auto max-w-3xl space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Link href={`/analysis/market-research/edit?id=${m.id}`}>
...
export default function MarketResearchDetailPageWrap() {
  return (
    <Suspense fallback={<LoadingSpinner className="h-8 w-8" />}>
      <MarketResearchDetailPage />
    </Suspense>
  );
}
